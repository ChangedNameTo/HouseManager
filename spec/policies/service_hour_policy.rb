...
RSpec.describe ServiceHourPolicy do
  ...
  let(:serv_man) { create(:user, :serv_man) }

  subject { described_class }

  # Members can add service hours, update them if they are theirs
  permissions :update?, :edit?, :destroy? do
    ...
    it 'allows if the user is a org manager or house manager' do
      ...
      expect(subject).to permit(serv_man)
